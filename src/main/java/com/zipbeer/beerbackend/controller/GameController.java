...
public class GameController {
    ...
    private String generateTopic(String gameType, String roomNo) {
        String[] catchMindTopics = {
                ...
                "바다", "산", "구름", "도넛", "새", "치즈", "호랑이", "침대", "의자", "책상", "지구본",
        ...
        String[] shoutInSilenceTopics = {
                ...
                "빵 굽기", "피자", "스턴트맨", "캠핑", "로봇", "탐정", "소방관", "유령", "병원", "디스코",
                "서핑", "헬리콥터", "무지개", "달리기", "야구", "아이언맨", "축제", "자전거", "드럼", "테니스",
                "미용사", "농부", "요리사", "연극", "미술가", "무술", "사자", "경찰", "우주", "비행사",
                "사진", "꽃", "피아노", "크리스마스", "비둘기", "영화", "스포츠카", "골프", "축하", "박수"
        };
